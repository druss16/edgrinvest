"""
Django settings for edgr_invest project.
...
WSGI_APPLICATION = 'edgr_invest.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, "frontend", "build"),  # Add React build directory
    os.path.join(BASE_DIR, "frontend", "src", "assets"),  # Include raw assets if needed
]
